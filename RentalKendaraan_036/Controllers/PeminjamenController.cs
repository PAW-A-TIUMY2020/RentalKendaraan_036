...
namespace RentalKendaraan_036.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TanggalPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
            ...
            ViewData["NamaCustomer"] = new SelectList(_context.Customer, "IdCustomer", "NamaCustomer", peminjaman.IdCustomerNavigation.NamaCustomer);
            return View(peminjaman);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPeminjaman,TanggalPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
